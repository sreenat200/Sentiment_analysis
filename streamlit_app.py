...
def process_audio(audio_file, model_size, progress_callback=None):
    try:
        ...
        try:
            # Initialize transcriber once per session
            ...
            # Prepare input for translate_to_malayalam
            ...
            # Segment sentences for alignment
            sentences = nltk.sent_tokenize(raw_transcription)
            ml_translations = nltk.sent_tokenize(ml_translation) if ml_translation else ["" for _ in sentences]
